...
summary: Snap Creator provides command-line functionality that enables you to perform various actions without using the graphical user interface \(GUI\). For instance, you can createa backup, clonea volume or LUN, and import configuration files from the command-line interface \(CLI\).
---
